...
module.exports = {
    ...
    editorTheme: {
        ...
        page: {
            title: "Design - STM32CubeMonitor",
            favicon: path.join(__dirname, "ressources", "CubeMonitor.ico"),
            css: path.join(__dirname, "ressources", "custo.css"),
        },
        header: {
            title: " ",
            image: path.join(__dirname, "ressources", "CubeMonitorTitleHigh.jpg"), // or null to remove image
            //        url: "http://www.st.com" // optional url to make the header text/image a link to this url
        },
        deployButton: {
            type: "simple",
            label: "DEPLOY",
        ...
        login: {
            image: path.join(__dirname, "ressources", "cube.ico")
            //    image: "/absolute/path/to/login/page/big/image" // a 256x256 image
        }
    },

    // the directory path where to save the data log files
    // by default the path is set to LOGPATH environment variable if it exists, otherwise it is set to homedir/log
    // logpath: process.env.LOGPATH || path.join(homedir, "log"),
    // logpath: process.env.LOGPATH || path.join(homedir, "log"),
    logpath: "C:\\PARTICLE_LOCAL\\JP3\\cubemonitor\\logs\\",
    // logpath: "C:\PARTICLE_LOCAL\JP3\cubemonitor\logs"),
}
